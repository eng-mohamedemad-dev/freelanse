...
<div class="wg-box">
    <form class="form-new-product form-style-1" method="POST" enctype="multipart/form-data" action="{{ route('admin.categories.store') }}">
        ...
        <fieldset class="name">
            ...
            <input type="text" placeholder="{{ __('admin.enter_category_name') }}" name="name" tabindex="0" value="{{ old('name') }}" aria-required="true" required>
        ...
        <fieldset class="description">
            ...
            <textarea name="description" placeholder="{{ __('admin.enter_category_description') }}" tabindex="0" aria-required="true" required>{{ old('description') }}</textarea>
