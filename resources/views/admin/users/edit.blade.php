...
<div class="flex items-center flex-wrap justify-between gap20 mb-27">
    <h3>{{ __('admin.edit_user') }}: {{ $user->name }}</h3>
    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
        ...
        <li>
            <div class="text-tiny">{{ __('admin.edit_user') }}</div>
        </li>
    </ul>
</div>

<div class="wg-box modern-form-container">
    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="form modern-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary btn-modern">
                <i class="icon-save"></i>
                <span>{{ __('admin.update_user') }}</span>
            </button>
